...
class GumballMachine
{
	...
	private $db_name="user01_test_p"; //a remplir
	...
	function __construct()
	{
		...
		*/
	    ...
	    try
	    {
		    ...
		    $sql="DROP SCHEMA IF EXISTS `user01_test_p` CREATE SCHEMA IF NOT EXISTS `user01_test_p` DEFAULT CHARACTER SET utf8 ; USE `user01_test_p`;";
		    $this->bdd->exec($sql) or die("DB ERROR: " . $e->getMessage());
		    $this->bdd = new PDO('mysql:host=192.168.250.3;dbname=user01_test_p;charset=utf8', 'user01', 'user01');
